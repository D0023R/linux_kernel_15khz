...
- *Stable* release: **7.2.8**
- *Longterm* release: **6.18.54**
- *Longterm* release: **6.12.111**
- *Longterm* release: **6.6.157**
- *Longterm* release: **6.1.188**

**Untested experimental:** 

- *Next* release: **next-20260213**

(+) filename and patch version depend on the selected kernel revision.
...
|+| 09_linux_15khz_i915_gen9_interlace.patch                     | optional, since kernel 6.18, target i915 driver, enable interlaced mode on Intel Gen9 (DISPLAY_VER 9) via i915.no_ytiled_scanout=1 |
